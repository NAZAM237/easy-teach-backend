...
public class UpdateCourseTest {
    ...
    public void updateExistingCourseTest() {
        ...
        var updateCourseCommandHandler = new UpdateCourseCommandHandler(userRepository, courseRepository);
    ...
    public void updateNonExistingCourseTest_shouldThrowException() {
        ...
        Assert.assertEquals("Course does not exist", throwResult.getMessage());
    }
}
